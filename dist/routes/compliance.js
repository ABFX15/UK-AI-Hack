...
router.post('/analyze-protocol', async (req, res) => {
    try {
        ...
        const aiResponse = await axios_1.default.post(`${AI_SERVICE_URL}/analyze-protocol-risk`, {
            protocol_address,
            institution_address
        });
...
router.post('/analyze-transaction', async (req, res) => {
    try {
        ...
        const aiResponse = await axios_1.default.post(`${AI_SERVICE_URL}/analyze-aml-compliance`, {
...
router.get('/report/:institutionId', async (req, res) => {
    try {
        ...
        const aiResponse = await axios_1.default.post(`${AI_SERVICE_URL}/generate-compliance-report`, {
